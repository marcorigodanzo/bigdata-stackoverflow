...
//  }
  ...
  // Tests taken from http://fruzenshtein.com/coursera-spark-week-2-and-3/
  ...
  test("Vectors for clustering") {
    val questionsWithTopAnswer = List(
      (Posting(1, 1, None, None, 0, Some("Java")), 14), // java 1
      (Posting(1, 1, None, None, 0, None), 5), // None missing
      (Posting(1, 1, None, None, 0, Some("Scala")), 25), // Scala 10
      (Posting(1, 1, None, None, 0, Some("JavaScript")), 3) // Javascript 0
    )
